...
class PrepareAndFinalize(ABC):
    ...
    def prepare(
        ...
        Args:
            ...
            token_top_ks (Optional[torch.Tensor]): Per-token, per-layer top-k values
...
class PrepareAndFinalizeWithAllGather(PrepareAndFinalize):
    ...
    def prepare(
        ...
        return self._prepare_with_dp_group(
            hidden_states, router_logits, token_top_ks, enable_shared_expert_dp, replace_allreduce, quant_type
        )
